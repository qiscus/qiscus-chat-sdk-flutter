var jsonRoomWithUserId = <String, dynamic>{
  'avatar_url':
      'https://d1edrlpyc25xu0.cloudfront.net/sdksample/image/upload/f6mXHZrxoD/bootcam.jpg',
  'chat_type': 'single',
  'id': 3148043,
  'id_str': '3148043',
  ...
  'participants': <Map<String, dynamic>>[
    ...
    <String, dynamic>{
      ...
      'email': 'guest-1001',
      'extras': <String, dynamic>{'extras': true},
      'id': 44465689,
      'id_str': '44465689',
      'last_comment_read_id': 282543832,
      'last_comment_read_id_str': '282543832',
...
var jsonRoomWithIdComment = <String, dynamic>{
  ...
  'user_avatar_url':
      'https://d1edrlpyc25xu0.cloudfront.net/sdksample/image/upload/GoLdHEInn5/Screenshot+(11).png',
  'user_extras': <String, dynamic>{'extras': true},
  'user_id': 44465689,
  'user_id_str': '44465689',
  'username': 'guest-1001'
};

var jsonRoomWithIdRoom = <String, dynamic>{
  'avatar_url':
      'https://d1edrlpyc25xu0.cloudfront.net/kiwari-prod/image/upload/75r6s_jOHa/1507541871-avatar-mine.png',
  'chat_type': 'single',
  'id': 4411750,
